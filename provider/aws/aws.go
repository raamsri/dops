...
// Route53API is the subset of the AWS Route53 API
...
func (p *AWSProvider) records(ctx context.Context, zones map[string]*route53.HostedZone) ([]*endpoint.Endpoint, error) {
	...
	f := func(resp *route53.ListResourceRecordSetsOutput, lastPage bool) (shouldContinue bool) {
		for _, r := range resp.ResourceRecordSets {
			...
			// See: https://github.com/toppr-systems/dops/pull/122/files/74e2c3d3e237411e619aefc5aab694742001cdec#r109863370
